...
exports.createPages = async ({ graphql, actions }) => {
  ...
  const portfolioContent = path.resolve(`./src/templates/portfolioContent.js`)
  ...
  allWordpressPage.edges.forEach(edge => {
    ...
    createPage({
      ...
      path: edge.node.path,
      component: slash(edge.node.template == 'page-portfolio.php' ? portfolioContent : pageTemplate),
      context: edge.node,
    })
  })
